...
output "monitoring_dashboard_url" {
  ...
  value       = (var.enable_monitoring && local.monitoring_dashboard_id != "") ? format("https://console.cloud.google.com/monitoring/dashboards/custom/%s?project=%s", local.monitoring_dashboard_id, var.project_id) : "Monitoring disabled"
}
